...
GraphAssist is built around **offloading repetitive, uncreative image work to the tool** — CLI, ImageJob, and Batch manifests make pipelines repeatable.

| Guide | Description |
|-------|-------------|
| [quickstart.md](../quickstart.md) | Setup and first conversion |
| [convert.md](convert.md) | Batch convert |
| [operations.md](operations.md) | All subcommands and operations |
...
| [lineart.md](lineart.md) | LineArt JSON creation and SVG/PNG rendering |
